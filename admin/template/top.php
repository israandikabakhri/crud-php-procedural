...
<div class="pace-activity"></div></div>
    ...
    <style type="text/css">
        :root {
          ...
          --nmain-color: #fff;
          --nmain-bg-color: #6C3483;
          --nmain-bg-color-hover: #8E44AD;
          --ncont-bg-color: #E8DAEF;
                ...
                <div class="mbr-table">
                    <div class="mbr-table-cell">
                        <div class="navbar-brand">
                            ...
                            <a class="navbar-caption" href="#" style="font-size: 15px;font-weight: bold;">TEMANKU</a>
                        </div>
                    </div>
                    <div class="mbr-table-cell">
                        ...
                        <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm" id="exCollapsingNavbar">
                            ...
                            <li class="nav-item"><a class="nav-link link" href="view.php">Kelola Data</a></li>
